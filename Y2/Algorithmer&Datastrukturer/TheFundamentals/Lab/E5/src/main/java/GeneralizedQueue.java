...
public class GeneralizedQueue<Item extends Comparable<Item>> implements Queue<Item> {
    private int size;
    ...
    public static class Test {
        private Queue<Integer> queue = new GeneralizedQueue<>();
        ...
        private void test() {
            Queue<Integer> queue = new GeneralizedQueue<>();
            for (int i = 0; i < 10; i++) {
                queue.enqueue(i);
                if (i == 3) {
                    queue.dequeue();
