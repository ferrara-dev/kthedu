 ...
 *
 * if <code> debugPrint </code> is set to true at instatiation,
 * the current state of the array will be printed with each swap
 * aswell as the total number of swaps.
 *
 * If the array that is to be sorted is in desceding order
 * the worst case time complexity of O(N^2) will occur,
 * because the inner loop will perform 1 + 2 + 3 + ... n
 *
 */
