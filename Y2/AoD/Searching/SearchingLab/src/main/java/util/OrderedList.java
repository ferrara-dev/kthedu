 ...
 *
 */
public class OrderedList<Item extends Comparable<Item>> implements Iterable<Item> {
    ...
    private boolean lessOrEquals(Item thisItem, Item thatItem) {
    ...
    public static void main(String... args) {
        OrderedList<Integer> queue = new OrderedList();
        queue.enqueue(1);
        queue.enqueue(3);
        queue.enqueue(2);
        queue.dequeue();
