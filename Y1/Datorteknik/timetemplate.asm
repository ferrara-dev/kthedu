...
time2string:
    ...
    add     $s1,$0,$a1      # s0 innehåller information om den befintliga tiden
	...
	nop
	sb      $v0, 0($s0)     # spara returvärdet från hexasc i timstr som a0 pekar på
	...
	jal     hexasc      	## nödvändigt eftersom hexasc endast utför beräkningar på de 4 sista bitarna
	nop
	sb      $v0,1($s0)      # Spara returvärdet från hexasc i den adress som a0 pekar till 
	...
	jal     hexasc				## nödvändigt eftersom hexasc endast utför beräkningar på de 4 sista bitarna
	nop
	sb      $v0,3($s0)		# Spara returvärdet från hexasc i den adress som a0 pekar till 


	move    $a0,$s1         # kopiera över den befintliga tiden från $s1 till $a0
	jal     hexasc				## INTE nödvändigt att extrahera LSB eftersom hexasc 
        							## endast utför beräkningar på de 4 sista bitarna
	nop
	sb      $v0, 4($s0)
