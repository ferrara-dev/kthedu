...
/*
 *  PORTF är kopplad till LCD display
 */
#define DISPLAY_CHANGE_TO_COMMAND_MODE (PORTFCLR = 0x10) // Write clears selected bits in PORTF, read yields undefined value
#define DISPLAY_CHANGE_TO_DATA_MODE (PORTFSET = 0x10) //  Write sets selected bits in PORTF, read yields undefined value
/*
 *
 */
